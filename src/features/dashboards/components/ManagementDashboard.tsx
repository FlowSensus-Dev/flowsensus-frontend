...
export default function ManagementDashboard({
  ...
  const pendingApprovals = applicants.filter((a) => a.phase === 3 && a.status.includes('CV')).slice(0, 4);

  // Near-deployment applicants (Phase 4-5)
  const nearDeployment = applicants.filter((a) => a.phase >= 4);
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-emerald-50/50 rounded-lg p-4 border border-emerald-200">
              ...
              <p className="text-2xl font-black text-[#10B981]">{nearDeployment.slice(0, 3).length}</p>
            ...
            <div className="bg-blue-50/50 rounded-lg p-4 border border-blue-200">
              ...
              <p className="text-2xl font-black text-[#0EA5E9]">{nearDeployment.slice(3, 6).length}</p>
          ...
          <div className="mt-6">
            ...
            <div className="space-y-2">
              {nearDeployment.slice(0, 3).map((applicant) => (
                <div
                  key={applicant.id}
