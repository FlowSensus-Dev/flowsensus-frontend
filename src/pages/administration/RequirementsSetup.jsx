...
const JOB_TYPE_OPTIONS = [
  ...
  { value: 'professional', label: 'Professional / Licensure' },
  { value: 'skilled',      label: 'Skilled / Technical (TESDA)' },
  { value: 'hsw',          label: 'Domestic / Household (HSW)' },
  { value: 'sea_based',    label: 'Sea-Based / Maritime' },
  { value: 'driver',       label: 'Drivers (LTO Professional)' },
];
...
export default function RequirementsSetup({ showToast, currentUserName }) {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          {['all', 'new_ofw', 'returning_ofw', 'muslim'].map(f => (
            <button
              key={f}
              onClick={() => setFilter(f)}
                  ...
                  <td className="px-4 py-3">
                    <div className="flex flex-wrap gap-1">
                      {(req.applicableJobTypes || ['all']).map(jt => {
                        ...
                        const color = JOB_TYPE_COLORS[jt] || '#64748B';
                        return (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={e => setEditing(p => p ? { ...p, appliesTo: e.target.value } : p)}
                  ...
                  >
                    {Object.keys(APPLIES_TO_LABELS).map(k => (
